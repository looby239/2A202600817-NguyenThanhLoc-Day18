...
class BM25Search:
    ...
    def index(self, chunks: list[dict]) -> None:
        ...
        for chunk in chunks:
            ...
            self.corpus_tokens.append(segmented.split())
    ...
    def search(self, query: str, top_k: int = BM25_TOP_K) -> list[SearchResult]:
        ...
        top_indices = sorted([i for i in range(len(scores)) if scores[i] > 0], key=lambda i: scores[i], reverse=True)[:top_k]
        return [SearchResult(
